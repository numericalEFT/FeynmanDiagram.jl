...
import FeynmanDiagram.FrontEnds: BareHoppingId, BareGreenNId
using LinearAlgebra
...
No = 9
bond(o, rin, rout) = BareHoppingId(para, (rin, rout), (o, o), (o, o))
...
const tree2 = Graph([diag2_11_1, diag2_11_2])
...
const tree3 = Graph([diag2_13_1, diag2_13_2])
...
const tree4 = Graph([diag3_12_1, diag3_12_2])
...
const tree5 = Graph([diag4_11_1, diag4_11_2, diag4_11_3, diag4_11_4, diag4_11_5])
...
function run(totalStep)
	...
	config = Configuration(; var = (T, O), dof = dof, obs = obs, reweight = [1.0, 1.0, 1.0, 1.0, 0.5, 0.25, 0.125, 0.125 / 2])
	result = integrate(integrand; config = config, neval = totalStep, measure = measure, print = 2, Nblock = 8)
